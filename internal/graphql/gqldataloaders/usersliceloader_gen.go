...
func (l *UserSliceLoader) Load(key int) ([]*entity.User, error) {
...
func (l *UserSliceLoader) LoadThunk(key int) func() ([]*entity.User, error) {
	l.mu.Lock()
...
func (l *UserSliceLoader) LoadAll(keys []int) ([][]*entity.User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserSliceLoader) LoadAllThunk(keys []int) func() ([][]*entity.User, []error) {
	results := make([]func() ([]*entity.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserSliceLoader) Prime(key int, value []*entity.User) bool {
	l.mu.Lock()
	var found bool
	if _, found = l.cache[key]; !found {
		// make a copy when writing to the cache, its easy to pass a pointer in from a loop var
		// and end up with the whole cache pointing to the same value.
		cpy := make([]*entity.User, len(value))
		copy(cpy, value)
		l.unsafeSet(key, cpy)
	}
	l.mu.Unlock()
...
func (l *UserSliceLoader) unsafeSet(key int, value []*entity.User) {
	if l.cache == nil {
